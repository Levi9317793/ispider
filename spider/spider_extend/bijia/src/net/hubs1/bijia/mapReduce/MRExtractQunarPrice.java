...
public class MRExtractQunarPrice implements MRinterface{

	
	private static final Log logger = LogFactory.getLog(MRExtractQunarPrice.class);

	static class MyMapper extends TableMapper<ImmutableBytesWritable, Put> {
		public static String rowKeyPrefix="qunar.price";
		@Override
	...
	public boolean mapStart(String sourceSite){
		...
		try{
			...
			Job job = new Job(config, "QunarPriceExtract");
			job.setJarByClass(MRExtractQunarPrice.class); // class that contains mapper
